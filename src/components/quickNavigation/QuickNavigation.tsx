...
export default function QuickNavigation() {
  ...
  return (
    <div
      className={`quick-navigation fixed bottom-5 right-5 z-30 grid justify-items-end gap-3 sm:bottom-8 sm:right-8 ${isOpen ? "is-open" : ""}`}
    >
      {isOpen && (
        <div className="quick-navigation-panel w-[min(22rem,calc(100vw-2rem))] border border-line-strong bg-surface shadow-panel">
