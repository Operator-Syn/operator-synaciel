...
export default function TermsAndConditions() {
  ...
  const updateSectionHash = useCallback((sectionId: string) => {
  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      const scrollableDistance = Math.max(page.offsetHeight - window.innerHeight, 1);
          ...
          <header className="privacy-policy-hero">
            <div className="privacy-policy-hero-copy">
              ...
              <p className="privacy-policy-summary">
                These terms define the rules for using syn-forge.com, Operator-Syn, and related
                Syn-Forge applications that link to this page.
              </p>
              <p className="privacy-policy-summary">
                Covered applications generally run on syn-forge.com or a subdomain of syn-forge.com,
                unless a specific application provides separate terms.
              </p>
          ...
          >
            ...
            >
              ...
              <nav
                ...
                className="privacy-policy-action-list"
              >
                {termsSections.map((section, index) => (
                  <button
