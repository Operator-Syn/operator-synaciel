...
export const PORTFOLIO_MCP_INSTRUCTIONS =
  "This is the public, read-only Syn-Forge portfolio source for Operator-Syn. Prefer structured tools and resources, cite canonical portfolio URLs, distinguish portfolio evidence from inference, and never invent employers, clients, metrics, or skills.";
